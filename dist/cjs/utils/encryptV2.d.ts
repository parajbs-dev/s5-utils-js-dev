...
export declare const CID_TYPE_ENCRYPTED_LENGTH = 1;
export declare const ENCRYPTION_ALGORITHM_LENGTH = 1;
export declare const CHUNK_LENGTH_AS_POWEROF2_LENGTH = 1;
export declare const ENCRYPTED_BLOB_HASH_LENGTH = 33;
 ...
 */
export declare function generate_key(): Promise<Uint8Array>;
/**
 ...
 * @returns A Promise that resolves to a Uint8Array representing the generated key.
 */
export declare function generate_key_From_Seed(seedString: string): Promise<Uint8Array>;
/**
 ...
 */
export declare function encrypt_file_xchacha20(inputFile: Uint8Array, key: Uint8Array, padding: number, chunkIndex?: number | undefined): Promise<Uint8Array>;
/**
 ...
 */
export declare function getTransformerEncrypt(key: Uint8Array): TransformStream<Uint8Array, Uint8Array>;
