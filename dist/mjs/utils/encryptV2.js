...
import { convertMHashToB64url, calculateB3hashFromFile, } from "./blake3tools";
import { cidTypeEncrypted, mhashBlake3Default, encryptionAlgorithmXChaCha20Poly1305, } from "./constants";
 ...
 */
export async function encrypt_file_xchacha20(inputFile, key, padding, chunkIndex) {
    await sodium.ready;
 ...
 */
export function getTransformerEncrypt(key) {
